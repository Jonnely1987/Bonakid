...
<html>
  <head>
    ...
    />
    <title>Bellacita Dahican Beach House</title>
  </head>
    ...
    <main>
      ...
      >
        <div
          ...
          style='background-image: url("https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1473&q=80");'>
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-gray-300">
                    Greet the summer season with a stay at Belacita Dahican Beach House in Mati, Davao Oriental! A perfect home away from home,
                     this wonderful accommodation will make your summer getaway truly memorable.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center mt-32">
            ...
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
              <div class="relative flex flex-col min-w-0 break-words  w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                <img
                  alt="..."
                  src="<?php echo e(asset('img/lifeisabeach.png')); ?>"
        ...
        <div class="container mx-auto px-4">
          <div class="items-center flex flex-wrap">
            <div class="w-full md:w-4/12 ml-auto mr-auto px-4 ">
              <img alt="..." class=" shadow-lg" src="<?php echo e(asset('img/ilovemati.jpg')); ?>"/>
...
<?php /**PATH C:\Users\User\jetstream2\resources\views/landing.blade.php ENDPATH**/ ?>