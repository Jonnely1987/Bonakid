...
<?php endif; ?>
            ...
            <div class="flex text-align:center mx-auto">
                Or
            </div>
            <div class="flex items-center justify-end mt-4">
                <a  class="btn" href="<?php echo e(url('auth/google')); ?>" style="background: #29913b; color: #ffffff; padding: 10px; width: 100%; text-align: center; display: block; border-radius:3px;">
...
<?php endif; ?>
<?php /**PATH C:\Users\User\jetstream2\resources\views/auth/login.blade.php ENDPATH**/ ?>