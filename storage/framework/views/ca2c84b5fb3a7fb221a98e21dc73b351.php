...
} elseif ($_instance->childHasBeenRendered('A5avq7l')) {
    $componentId = $_instance->getRenderedChildComponentId('A5avq7l');
    $componentTag = $_instance->getRenderedChildComponentTagName('A5avq7l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('A5avq7l');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('A5avq7l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\User\jetstream2\resources\views/layouts/app.blade.php ENDPATH**/ ?>